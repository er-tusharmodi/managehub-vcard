{{-- coaching-template/_common.blade.php --}}
{{-- Basic Info for Coaching Academy — syncs to shop.* via _field_config._common --}}

{{-- ── Academy Identity ──────────────────────────────────────────── --}}
<div class="col-12 mb-3">
    <h6 class="fw-semibold text-muted text-uppercase mb-3" style="font-size:.72rem;letter-spacing:.07em;">
        <i class="mdi mdi-school-outline me-1"></i>Academy Identity
    </h6>
</div>

<div class="col-lg-6 mb-3">
    <label class="form-label fw-semibold" for="common-name">Academy Name</label>
    <input type="text"
           id="common-name"
...
<div class="col-lg-6 mb-3">
    ...
    <input type="text"
           ...
           placeholder="UPSC · SSC · Banking · State PSC Coaching">
    @error('form.tagline')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
