...
$fields = [
    ...
    ['key'=>'price', 'label'=>'Price', 'type'=>'text', 'span'=>'col-md-3', 'placeholder'=>'₹79,999'],
    ['key'=>'oldPrice', 'label'=>'Old Price', 'type'=>'text', 'span'=>'col-md-3', 'placeholder'=>'₹89,999'],
    ['key'=>'tag', 'label'=>'Tag', 'type'=>'text', 'span'=>'col-md-4', 'placeholder'=>'New Launch'],
    ['key'=>'tagColor', 'label'=>'Tag Color', 'type'=>'text', 'span'=>'col-md-4', 'placeholder'=>'#e74c3c'],
];
@endphp
