{{--
 | restaurant-cafe-template/_common.blade.php
 | "Basic Info" for restaurant-cafe — same as _shared/_common but adds
 | the "Eyebrow" line shown under the restaurant name (e.g. "Est. 2018 · Fine Dining & Café").
--}}
...
<div class="col-lg-6 mb-3">
    <label class="form-label fw-semibold" for="common-eyebrow">
        Eyebrow Line
        <span class="text-muted fw-normal ms-1" style="font-size:.78rem;">(shown on the banner below the name)</span>
    </label>
    <input type="text"
           id="common-eyebrow"
           class="form-control @error('form.eyebrow') is-invalid @enderror"
           wire:model="form.eyebrow"
           placeholder="Est. 2018 · Fine Dining & Café">
    @error('form.eyebrow')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
    <small class="text-muted">
        <i class="mdi mdi-information-outline me-1"></i>
        e.g. <em>Est. 2018 · Fine Dining &amp; Café</em>
    </small>
</div>
