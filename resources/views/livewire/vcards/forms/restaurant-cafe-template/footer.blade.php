{{-- restaurant-cafe-template/footer.blade.php — {year, brand, rights, poweredBy, poweredBrand} --}}

@php
    $autoName = isset($vcard)
        ? (data_get($vcard->data_content ?? [], '_common.name', '') ?: data_get($vcard->data_content ?? [], 'meta.title', ''))
        : '';
@endphp
