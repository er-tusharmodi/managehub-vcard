...
<div class="col-12">
    <div class="row g-2 rc-gallery-grid" data-sort-path="">
        @foreach(($form ?? []) as $gi => $gItem)
        <div class="col-6 col-md-4 col-lg-3 rc-gallery-item" wire:key="rc-gal-{{ $gi }}">
...
<div class="col-12 mt-3"
    ...
    <div class="border rounded p-3 bg-light">
        ...
        <input type="file" id="rc-gallery-multi-add"
