{{--
 | sweetshop-template/_common.blade.php
 | "Basic Info" form for sweetshop — same as _shared/_common but adds
 | the Description field and omits the Social Media block (social is
 | managed via the dedicated "Social Links" section).
--}}
...
<div class="col-lg-6 mb-3">
    ...
    <input type="text"
           ...
           placeholder="e.g. Premium Indian Sweets & Mithai">
    @error('form.tagline')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="col-12 mb-3">
    <label class="form-label fw-semibold" for="common-description">About / Description</label>
    <textarea id="common-description"
              class="form-control @error('form.description') is-invalid @enderror"
              wire:model="form.description"
              rows="3"
              placeholder="Tell customers about your shop, specialities, history…"></textarea>
