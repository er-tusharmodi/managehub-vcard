@php
    require_once resource_path('views/vcards/icons/minimart-template.php');
        ...
        <main id="app-root" aria-live="polite" style="min-height: 100vh">
            <div class="banner" id="bannerRoot"{{ $bannerImage ? " style=\"background:url('" . e($bannerImage) . "') center/cover no-repeat\"" : "" }}>
                ...
                <div class="banner-icons" id="bannerIcons">
                    @foreach(data_get($data, "banner.icons", []) as $item)
                        @php $iconKey = "banner_" . ($item["icon"] ?? ""); @endphp
                ...
                <div class="banner-top-bar">
                    <button class="share-btn" onclick="openShare()">
                        ...
                        <span id="topShareLabel">{{ data_get($data, "banner.topBar.share") }}</span>
                    </button>
                    <button class="save-btn-top" onclick="saveContact()">
                        ...
                        <span id="topSaveLabel">{{ data_get($data, "banner.topBar.saveCard") }}</span>
                    </button>
                </div>
            </div>
            ...
            <div class="profile-card">
                <div class="profile-avatar-wrap">
                    <div class="profile-avatar">
                        <img id="profileImage" src="{{ $profileImage }}" alt="{{ $profileAlt }}" style="width: 100%; height: 100%; object-fit: cover" />
                    </div>
                </div>
                <div class="profile-name" id="profileName">{{ data_get($data, "profile.name") }}</div>
                <div class="profile-role" id="profileRole">{{ data_get($data, "profile.role") }}</div>
                <div class="profile-bio" id="profileBio">{{ data_get($data, "profile.bio") }}</div>
                <div class="profile-action-btns">
                    ...
                    <button class="pab save" onclick="saveContact()">
                        ...
                        <span id="actionSaveLabel">{{ data_get($data, "profile.actions.save") }}</span>
                    </button>
            ...
            <div class="badge-strip" id="badgeStrip">
                @foreach(data_get($data, "badges", []) as $item)
                    @php $badgeKey = "badge_" . ($item["icon"] ?? ""); @endphp
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionLocationTitle">{{ data_get($data, "sections.location.title") }}</div>
                </div>
                <div class="sec-body">
                    <a class="address-link" href="#" onclick="return (openMaps(), !1);">
                        ...
                        <div class="addr-text">
                            <strong id="locationLine1">{{ data_get($data, "sections.location.addressLine1") }}</strong>
                            <span id="locationLine2">{{ data_get($data, "sections.location.addressLine2") }}</span>
                            <span class="map-btn">
                                <svg style="stroke: #fff; fill: none; width: 11px; height: 11px; stroke-width: 2" viewBox="0 0 24 24">
                                    <polygon points="3 11 22 2 13 21 11 13 3 11" />
                                </svg>
                                <span id="locationMapLabel">{{ data_get($data, "sections.location.mapLabel") }}</span>
                            </span>
                        </div>
                    </a>
                </div>
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionSocialTitle">{{ data_get($data, "sections.social.title") }}</div>
                </div>
                <div class="sec-body">
...
@endphp
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionCategoriesTitle">{{ data_get($data, "sections.categories.title") }}</div>
                </div>
                <div class="sec-body">
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionPicksTitle">{{ data_get($data, "sections.picks.title") }}</div>
                </div>
                <div class="sec-body">
...
@endphp
                            <div class="prod-card">
                                <div class="prod-img">
                                    ...
                                    @if(!empty($item["tag"]))
                                        <span class="prod-tag" style="background:{{ $item["tagColor"] ?? "#dc2626" }}">{{ $item["tag"] }}</span>
                                    @endif
                                </div>
                                <div class="prod-body">
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionDealsTitle">{{ data_get($data, "sections.deals.title") }}</div>
                </div>
                <div class="sec-body">
                    <div class="deals-list" id="dealsList">
                        @foreach(data_get($data, "deals", []) as $item)
                            @php
...
@endphp
                            <div class="deal-item">
                                ...
                                <button class="deal-cta" onclick="{{ $action }}">{{ $actionLabel }}</button>
                            </div>
                        @endforeach
                    </div>
                </div>
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionGalleryTitle">{{ data_get($data, "sections.gallery.title") }}</div>
                </div>
                <div class="sec-body">
...
@endphp
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionHoursTitle">{{ data_get($data, "sections.hours.title") }}</div>
                </div>
                <div class="sec-body">
                    <div class="today-badge">
                        ...
                        <span id="todayBadgeText">{{ data_get($data, "sections.hours.todayLabel") }}</span>
                    </div>
                    <table class="hours-table">
                        <tbody id="hoursRows">
                            @foreach(data_get($data, "sections.hours.rows", []) as $row)
                                @php $open = ($row["status"] ?? "") !== "closed"; @endphp
                    ...
                    <div class="suggest-link" onclick="emailShop()">
                        ...
                        <span id="hoursSuggestLabel">{{ data_get($data, "sections.hours.suggestLabel") }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionQrTitle">{{ data_get($data, "sections.qr.title") }}</div>
                </div>
                <div class="sec-body">
                    <div class="qr-card-inner">
                        <p id="qrHelpText" style="font-size: 0.77rem; color: var(--muted); margin-bottom: 0.2rem">{{ data_get($data, "sections.qr.helpText") }}</p>
                        <div id="vcardQR"></div>
                        <div class="qr-actions">
                            <button class="qr-btn" onclick="downloadQR()">
                                ...
                                <span id="qrDownloadLabel">{{ data_get($data, "sections.qr.download") }}</span>
                            </button>
                            <button class="qr-btn" onclick="copyLink()">
                                ...
                                <span id="qrCopyLabel">{{ data_get($data, "sections.qr.copy") }}</span>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionPaymentsTitle">{{ data_get($data, "sections.payments.title") }}</div>
                </div>
                <div class="sec-body">
...
@endphp
            ...
            <div class="sec">
                <div class="sec-header">
                    ...
                    <div class="sec-title" id="sectionContactTitle">{{ data_get($data, "sections.contact.title") }}</div>
                </div>
                <div class="sec-body">
                    <div id="contactForm">
                        <div class="bf-row">
                            <div class="bf-group">
                                <label class="bf-label" id="contactLabelName">{{ data_get($data, "sections.contact.form.nameLabel") }}</label>
                                <input class="bf-input" id="cName" placeholder="{{ data_get($data, "sections.contact.form.namePlaceholder") }}" />
                            </div>
                            <div class="bf-group">
                                <label class="bf-label" id="contactLabelPhone">{{ data_get($data, "sections.contact.form.phoneLabel") }}</label>
                                <input class="bf-input" id="cPhone" type="tel" placeholder="{{ data_get($data, "sections.contact.form.phonePlaceholder") }}" />
                            </div>
                        </div>
                        <div class="bf-group">
                            <label class="bf-label" id="contactLabelEmail">{{ data_get($data, "sections.contact.form.emailLabel") }}</label>
                            <input class="bf-input" id="cEmail" placeholder="{{ data_get($data, "sections.contact.form.emailPlaceholder") }}" />
                        </div>
                        <div class="bf-group">
                            <label class="bf-label" id="contactLabelMessage">{{ data_get($data, "sections.contact.form.messageLabel") }}</label>
                            <textarea class="bf-input" id="cMsg" placeholder="{{ data_get($data, "sections.contact.form.messagePlaceholder") }}"></textarea>
                        </div>
                        <button class="cf-submit" onclick="submitContact()">
                            ...
                            <span id="contactSubmitLabel">{{ data_get($data, "sections.contact.form.submit") }}</span>
                        </button>
                    </div>
                    <div id="contactSuccess" style="display: none; text-align: center; padding: 1.6rem 1rem">
                        ...
                        <div id="contactSuccessTitle" style="font-size: 0.96rem; font-weight: 800; color: var(--text); margin-bottom: 0.38rem">{{ data_get($data, "sections.contact.success.title") }}</div>
                        <div id="contactSuccessText" style="font-size: 0.78rem; color: var(--muted); margin-bottom: 0.9rem">{{ data_get($data, "sections.contact.success.text") }}</div>
                        <button class="cf-submit" onclick="resetContact()">
                            ...
                            <span id="contactAnotherLabel">{{ data_get($data, "sections.contact.success.button") }}</span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="vcard-footer">
                ...
                <p id="footerLine2" style="margin-top: 0.3rem; font-size: 0.66rem">{{ data_get($data, "footer.poweredBy") }} <strong>{{ data_get($data, "footer.poweredBrand") }}</strong></p>
            </div>
            ...
            <div class="float-bar">
                ...
                <button class="fab save-fab" onclick="saveContact()">
                    ...
                    <span id="floatSaveLabel">{{ data_get($data, "floatBar.saveCard") }}</span>
                </button>
                ...
                <div class="fab cart-fab fab-wrap" onclick="openCart()">
                    ...
                    <span id="floatCartLabel" style="font-size: 0.65rem; font-weight: 800; color: var(--navy)">{{ data_get($data, "floatBar.cart") }}</span>
                </div>
            </div>
                ...
                <div class="cart-box">
                    <div class="cart-header">
                        <div class="cart-title">
                            ...
                            <span id="cartTitle">{{ data_get($data, "sections.cart.title") }}</span>
                        </div>
            ...
            <div class="modal-overlay" id="shareModal" onclick="closeShare(event)">
                <div class="modal-box">
                    <div class="modal-title" id="shareTitle">{{ data_get($data, "sections.share.title") }}</div>
                    <div class="share-options">
                        <div class="share-opt" onclick="shareWA()">
                            <svg viewBox="0 0 24 24" stroke="#15803d" stroke-width="2">
                                <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
                            </svg>
                            <span id="shareWaLabel">{{ data_get($data, "sections.share.whatsapp") }}</span>
                        </div>
                        <div class="share-opt" onclick="copyLink()">
                            ...
                            <span id="shareCopyLabel">{{ data_get($data, "sections.share.copy") }}</span>
                        </div>
                        <div class="share-opt" onclick="shareFB()">
                            <svg viewBox="0 0 24 24" stroke="#1877f2" stroke-width="2">
                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                            </svg>
                            <span id="shareFbLabel">{{ data_get($data, "sections.share.facebook") }}</span>
                        </div>
                        <div class="share-opt" onclick="shareNative()">
                            ...
                            <span id="shareMoreLabel">{{ data_get($data, "sections.share.more") }}</span>
                        </div>
                    </div>
                    <button class="modal-close-btn" onclick="closeShareModal()">
                        <span id="shareCancelLabel">{{ data_get($data, "sections.share.cancel") }}</span>
                    </button>
                </div>
            </div>
            ...
            <div class="promo-overlay" id="promoOverlay">
                <div class="promo-box">
                    ...
                    <h3 id="promoTitle">{{ data_get($data, "promo.title") }}</h3>
                    <p id="promoText">{{ data_get($data, "promo.text") }}</p>
                    <button class="promo-cta" onclick="promoAction()">
                        ...
                        <span id="promoButtonLabel">{{ data_get($data, "promo.button") }}</span>
                    </button>
                </div>
            </div>
